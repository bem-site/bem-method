...
* [Как переопределить CSS-свойства блока в точках останова (breakpoints) медиа-запросов?](#Как-переопределить-css-свойства-блока-в-точках-останова-breakpoints-медиа-запросов)
