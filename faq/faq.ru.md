...
Вы можете придерживаться любой из рекомендуемых структур файловых систем:
* [Nested-схема](../method/filesystem/filesystem.ru.md#Nested-схема).
* [Flex-схема](../method/filesystem/filesystem.ru.md#Flex-схема).
* [Flat-схема](../method/filesystem/filesystem.ru.md#Flat-схема).
