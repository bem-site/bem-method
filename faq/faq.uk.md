...
* [Навіщо писати ім'я блоку в іменах модифікаторів і елементів?](#Навіщо-писати-ім-блоку-в-іменах-модифікаторів-і-елементів)
...
* [Навіщо використовувати i-bem.js якщо можна писати на jQuery?](#Навіщо-використовувати-i-bem-якщо-можна-писати-на-jquery)
...
* [Можна об'єднувати тег і клас в селекторі (наприклад, button.button)?](#Можна-обєднувати-тег-і-клас-в-селекторі-наприклад-button.button)
* [Чому в БЕМ не використовують користувальницькі теги (custom tag) для блоків?](#Чому-в-БЕМ-не-використовують-користувальницькі-теги-custom-tag-для-блоків)
...
Ви можете дотримуватися будь рекомендованих структур файлових систем:
* [Nested-схема](../method/filesystem/filesystem.uk.md#Nested-схема).
* [Flex-схема](../method/filesystem/filesystem.uk.md#Flex-схема).
* [Flat-схема](../method/filesystem/filesystem.uk.md#Flat-схема).
