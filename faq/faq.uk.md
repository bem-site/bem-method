...
Дотримуватися [рекомендованої файлової структури проекту](../method/filesystem/filesystem.uk.md#nested) не обов'язково. Ви можете використовувати будь-яку альтернативну структуру проекту, відповідну принципам організації файлової системи БЕМ, наприклад:
