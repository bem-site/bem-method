...
Файлова структура БЕМ-проекту поділяється на вкладені директорії і файли для [зручності розробки і підтримки проекту](../method/filestructure/filestructure.uk.md#Реалізація-блоку-розділяється-на-окремі-файли).

Дотримуватися [рекомендованої файлової структури проекту](../method/filestructure/filestructure.uk.md#nested) не обов'язково. Ви можете використовувати будь-яку альтернативну структуру проекту, відповідну принципам організації файлової структури БЕМ, наприклад:
