...
Файлова система БЕМ-проекту поділяється на вкладені директорії і файли для [зручності розробки і підтримки проекту](../method/filestructure/filestructure.uk.md#Реалізація-блоку-розділяється-на-окремі-файли).
