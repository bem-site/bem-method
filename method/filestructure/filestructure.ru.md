...
```css
@import url(common.blocks/button/button.css);    /* Базовые CSS-правила */
@import url(desktop.blocks/button/button.css);   /* Особенности desktop */
```
...
```css
@import url(common.blocks/button/button.css);    /* Базовые CSS-правила */
@import url(mobile.blocks/button/button.css);    /* Особенности mobile */
```
