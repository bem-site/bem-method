...
> Докладніше про те, навіщо розділяти реалізацію блоку на окремі файли читайте в документі [Організація файлової структури БЕМ-проекту](../filestructure/filestructure.ru.md).
...
* [Перевизначення блоків бібліотеки](../filestructure/filestructure.ru.md#Підключення бібліотеки)
* [Поділ проекту на платформи](../filestructure/filestructure.ru.md#Поділ проекту на-платформи)
