...
Предположим, что появилась необходимость добавить на страницу кнопку большего размера.
...
Чтобы начать реализовать идеи БЭМ в вашем проекте, необходимо:
  ...
  * абстрагироваться от DOM-модели и научиться создавать независимые компоненты — блоки;
  * перестать использовать ID-селекторы и селекторы тегов;
  * работать в единых терминах блоков, элементов и модификаторов;
  * использовать соглашение по именованию CSS-классов, для того чтобы избежать коллизии имен и сделать имена CSS-селекторов максимально информативными и понятными;
