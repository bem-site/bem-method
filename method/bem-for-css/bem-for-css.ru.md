...
Таким образом, использование модификаторов избавляет нас от ненужного копипаста.
...
Самый быстрый путь — начать применять принципы БЭМ-методологии в своем проекте и получать первые результаты без использования специализированного фреймворка.

Чтобы реализовать сразу все идеи БЭМ в вашем проекте, необходимо использовать [шаблонный репозиторий для создания БЭМ-проектов](https://ru.bem.info/platform/project-stub/):
