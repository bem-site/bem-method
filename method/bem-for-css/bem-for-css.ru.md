...
В качестве примера рассмотрим группу CSS-селекторов:
...
С определенной долей вероятности можно предположить, что мы имеем дело с одним блоком и его HTML-реализация выглядит как-то так:
