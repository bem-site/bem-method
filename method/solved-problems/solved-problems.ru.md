...
* [Как создать простой в сопровождении код](#Как-создать-простой-в-сопровождении-код)
...
## Как создать простой в сопровождении код

**Проблема**

Ошибки в программах достаточно сложно отыскивать и исправлять. И эта сложность возрастает с течением времени, особенно если ошибки вкрадываются в уже выпущенный программный продукт. Проще всего исправлять ошибки в процессе работы, сразу же после их обнаружения, то есть пока ваши мысли крутятся вокруг проблемы, которую необходимо решить. Сделать это будет сложнее, когда вы забудете все, что связано с данным конкретным фрагментом кода.

Еще одна проблема, характерная для крупных компаний и проектов, состоит в том, что ошибку приходится исправлять уже другому разработчику. Поэтому очень важно сократить время, необходимое на то, чтобы понять, как действует программный код, написанный некоторое время тому назад вами или другим разработчиком.

Другой жизненный факт, связанный с разработкой ПО, заключается в том, что большая часть времени обычно тратится на чтение программного кода, а не на его написание. В результате для внесения изменений в программный код, который был написан за несколько человеко-часов, может потребоваться затратить несколько человеко-недель на его чтение. Именно поэтому так важно писать простой в сопровождении код.
