...
link's to faq updated
SUBMIT CHANGE REQUEST
bem-site / bem-method

method/key-concepts/key-concepts.ru.md
Review your changes:
...
>
>[Можно ли создавать элементы элементов?](../../faq/faq.ru.md#Можно-ли-создавать-элементы-элементов-block__elem1__elem2)
