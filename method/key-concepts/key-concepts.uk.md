...
БЕМ-сутність, що визначає зовнішній вигляд, стан і поведінку [блока](#Блок) чи [елементу](#Елемент).
...
Зміна [реалізацію](#Реалізація-блока) блока шляхом додання йому нових особливостей на іншому [рівні](#Рівень-перевизначення).
