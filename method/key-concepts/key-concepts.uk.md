...
Наприклад, якщо зовнішній вигляд блоку заданий за допомогою CSS, це означає, що блок реалізований в технології CSS. А якщо документація до блоку написана в форматі Markdown - блок реалізований в технології Markdown.
...
Наприклад, в проект на окремий рівень підключається стороння бібліотека, яка містить готові реалізації блоків. Проектні блоки зберігаються на іншому рівні перевизначення.
