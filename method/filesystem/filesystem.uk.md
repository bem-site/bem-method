...
Прийнятий у методології БЕМ компонентний підхід застосовується і до організації БЕМ-проектів у файловій системі. У БЕМ не тільки інтерфейс ділиться на незалежні компоненти — блоки, але і реалізація блоків ділиться на незалежні частини — файли.
