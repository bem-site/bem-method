...
В качестве примера рассмотрим CSS-селектор `menuitemvisible`. Быстрый просмотр такой записи не дает возможности определить типы БЭМ-сущностей по имени. Добавим разделитель:
...
**Важно!** В методологии БЭМ [модификатор не может использоваться в отрыве от своего владельца](https://github.com/bem/bem-method/blob/bem-fix-problems/method/faq/faq.ru.md#bem-mod-usage).
_________________________________________________
