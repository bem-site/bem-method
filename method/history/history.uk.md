...
Верстка большоего проекту була некерованою. Щоб уникнути цього, потрібно було визначити правила роботи з поняттями `класу`, `tag`, `візуального компонента` і не тільки.
