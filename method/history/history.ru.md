...
Одновременно с Музыкой началась вёрстка [Яру](http://wow.yandex.ru).
...
Наш внутренний инструмент вырост из простого perl скрипта в отдельный open source проект [borschik](https://github.com/veged/borschik).
...
которые назвали [абсолютно-независимые блоки](http://clubs.ya.ru/bem/replies.xml?item_no=43) (сокращённо АНБ):
...
[абсолютно-независимые блоки](http://clubs.ya.ru/bem/replies.xml?item_no=338).
...
### Open Source (2010)
В 2010 году мы создали организацию [bem на github’е](https://github.com/bem),
чтобы вести разработку в open source.

#### Библиотека bem-bl
Мы начали выносить блоки из Лего в [bem-bl](https://github.com/bem/bem-bl),
проводя одновременно с этим рефакторинг.

Вместе с выносом блоков публиковали информацию про них в клубе:
[Блок, Элемент, Модификатор (БЭМ, BEM)](http://clubs.ya.ru/bem/posts.xml?tag=8486525).

Работы по выносу блоков в Open Source пока не закончены.

#### Инструменты
Начали реализацию инструментов [bem-tools](https://github.com/bem/bem-tools),
...
О вариантах расположения на файловой системе, [читайте отдельно](/method/filesystem/).
