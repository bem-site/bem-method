...
В БЭМ к JavaScript применяются [дополнительные правила???](/bem-js-principles.ru.md), которые позволяют реализовать все [идеи компонентного подхода БЭМ-методологии](##Основные-принципы-компонентного-подхода-в-javascript-по-БЭМ).
