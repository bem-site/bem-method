...
* [Работа с блоками](#работа-с-блоками)
  ...
  * [Взаимодействие блока с элементами](#взаимодействие-блока-с-элементами)    
...
Элементы всегда являются внутренней реализацией блока, поэтому [обращение к ним](#взаимодействие-блока-с-элементами) возможно только через API самого блока.
...
> [Подробнее](../redefinition-levels/redefinition-levels.ru.md#обновление-подключенных-библиотек-блоков) о подключении библиотеки в проект.
