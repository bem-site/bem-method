...
* Имя модификатора отделяется от имени блока или элемента одним пробелом и записывается с именем блока или элемента отделяясь одинарным подчеркиванием (`_`).
...
* Структура полного имени модификатора соответствует схеме:
  * `имя-блока имя-блока_имя-модификатора`;
  * `имя-блока__имя-элемента имя-блока__имя-элемента_имя-модификатора`.
