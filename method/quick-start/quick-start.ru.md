...
* [БЭМ-сущностях](../key-concepts/key-concepts.ru.md#БЭМ-сущность), их особенностях и принципах работы с ними;
* файловой структуре БЭМ-проекта.
...
В БЭМ-методологии не рекомендуется создавать элементы элементов (block__elem1__elem2) -->
<form class="search-form">  
    <div class="search-form__content">  
...
1. Если фрагмент кода может использоваться повторно и не зависит от реализации других компонентов страницы, необходимо создавать [блок](../key-concepts/key-concepts.ru.md#Блок).
2. Если фрагмент кода не может использоваться самостоятельно, без родительской сущности (блока), в большинстве случаев создается [элемент](../key-concepts/key-concepts.ru.md#Элемент).
