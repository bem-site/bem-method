...
Каждый блок лежит в своей папке в файловой структуре, в которой сложены все технологии, описывающие блок, его элементы и модификаторы.
...
Приведём пример, как это выглядит в файловой структуре:
