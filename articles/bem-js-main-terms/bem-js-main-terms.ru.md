...
В стеке БЭМ-технологий есть [блок i-bem](https://ru.bem.info/technology/i-bem/current/i-bem-js/) библиотеки [bem-core](https://ru.bem.info/libs/bem-core/current/), который также называют блоком-хелпером. Его JavaScript-реализация использует предметную область БЭМ
