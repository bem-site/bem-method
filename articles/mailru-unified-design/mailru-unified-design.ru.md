<img width="500" height="376" src="http://www.jvetrau.com/wp-content/uploads/2015/02/01-Title.png" class="attachment-full wp-post-image" alt="Унификация дизайна: Фреймворк Mail.Ru Group для мобильного веба" title="">
...
_Статья написана [для Smashing Magazine](http://www.smashingmagazine.com/2015/02/04/product-design-unification-case-study-mobile-web-framework/)._
...
[![02-Overview-Full](http://www.jvetrau.com/wp-content/uploads/2015/02/02-Overview-Full-778x1024.png)](http://www.jvetrau.com/wp-content/uploads/2015/02/02-Overview-Full.png) Главная страница, Авто, Валюты, Гороскопы, Дети, Курсы, Леди, Новости, Ответы, Погода, Спорт, ТВ, Hi-Tech
...
![UI Kit в Photoshop](http://www.jvetrau.com/wp-content/uploads/2015/02/03-UIKit-Photoshop-Snapshot.png) Часть полотна UI Kit в Photoshop
...
```
    ...
    ![Шаблонизатор](http://www.jvetrau.com/wp-content/uploads/2015/02/04-TemplateEngine.png)<span>Общий принцип работы шаблонизатора</span>
    ...
    **Если мы нашли новое решение** для старого блока или компонента (например, новый вид фотогалерей), он меняется в макетах, прототипе и базе кода. После этого каждый проект обновляет его у себя из общего репозитария, почти как приложения из AppStore. При этом дизайнеру нужно проверить только одну реализацию в единой базе кода вместо того чтобы отслеживать каждый из сервисов. И можно быть уверенным в качестве реализованного дизайна.
    ...
    ![Текущий рабочий процесс](http://www.jvetrau.com/wp-content/uploads/2015/02/05-Process-Current.png) Текущий рабочий процесс с фреймворком
...
4.  **Рефакторинг дизайна**. Запуск десятка продуктов занимается достаточно внушительное время, за которое выявляются проблемы в реальной жизни сервисов. Да и дизайнерские тренды меняются.
    ...
    ![Главная Mail.Ru для мобильных, 2012](http://www.jvetrau.com/wp-content/uploads/2015/02/06-Home.png)Главная Mail.Ru для мобильных, 2012
    > Первая мобильная версия продукта Mail.Ru Group появилась в 2004 году — это была Почта.
> 
>     ![WAP-версия почты Mail.Ru © Компьютерра-Томск](http://www.jvetrau.com/wp-content/uploads/2015/02/07-Mail-WAP.png)
    ...
    ![Афиша, 2012](http://www.jvetrau.com/wp-content/uploads/2015/02/08-Afisha.png) Афиша, 2012
    ...
    ![Афиша без использования карточек](http://www.jvetrau.com/wp-content/uploads/2015/02/09-CardLess.png) Вариант дизайна без карточек
    ...
    ![Прототип в InDesign и макет в Photoshop](http://www.jvetrau.com/wp-content/uploads/2015/02/10-InDesign-vs-Photoshop.png) Сравнение прототипа в InDesign и макета в Photoshop
...
![Гороскопы](http://www.jvetrau.com/wp-content/uploads/2015/02/12-Horoscopes.png) Гороскопы
...
![Прототип живого гайдлайна](http://www.jvetrau.com/wp-content/uploads/2015/02/LiveStyleGuidealpha.png) Прототип живого гайдлайна, созданный в начале работы над фреймворком
...
![Афиша для современных тачфонов, старых смартфонов и кнопочных телефонов](http://www.jvetrau.com/wp-content/uploads/2015/02/15-TouchMTel.png) Версии Афиши для современных тачфонов, старых смартфонов и кнопочных телефонов
![Версия главной Mail.Ru для старых и современных Android-телефонов](http://www.jvetrau.com/wp-content/uploads/2015/02/16-AndroidSimplified.png) Версия главной Mail.Ru для старых и современных Android-телефонов
...
![Единые иконки приложений](http://www.jvetrau.com/wp-content/uploads/2015/02/18-Icons.png) Единые иконки приложений
...
![Освежение стиля](http://www.jvetrau.com/wp-content/uploads/2015/02/19-VisualRefresh.png) Освежение стиля, которое внедряется сейчас

Да&nbsp;и&nbsp;следующий тренд после флэт-дизайна подхватить будет легко и&nbsp;быстро ![:)](http://www.jvetrau.com/wp-includes/images/smilies/icon_smile.gif) Конечно, погоня за&nbsp;трендами&nbsp;— не&nbsp;самая похвальная затея. Однако в&nbsp;нашей индустрии периодически случаются достаточно резкие сломы визуальной парадигмы, как это было в&nbsp;прошлом году с&nbsp;выходом iOS7, и&nbsp;компании должны оперативно реагировать на&nbsp;них.

## Выводы

Изначально требовалось просто обновить дизайн контент-проектов на&nbsp;мобильных и&nbsp;сделать их&nbsp;похожими. Идея полной унификации, включая техническую часть, родилась по&nbsp;ходу работы и&nbsp;общения с&nbsp;разработчиками. Дружите с&nbsp;ними ![:)](http://www.jvetrau.com/wp-includes/images/smilies/icon_smile.gif) И&nbsp;не&nbsp;ждите указаний свыше&nbsp;— двигайте компанию вперед сами. Огромное спасибо всей команде дизайнеров (Константин Зубанов, Геворг Глечян, Александр Киров, Евгений Беляев, Артем Гладков, Павел Скрипкин) и&nbsp;разработчиков (Дмитрий Беляев, Арстан Торегожин, Андрей Кусимов, Борис Ребров, Павел Рыбин, Павел Вдовцев), благодаря которым все это случилось. В&nbsp;особенности&nbsp;— Антону Епреву, который заложил основу технологического решения.

![Будущий процесс работы](http://www.jvetrau.com/wp-content/uploads/2015/02/20-Process-Future.png)Рабочий процесс в ближайшем будущем
