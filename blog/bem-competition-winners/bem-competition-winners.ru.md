...
Хочу сказать автору спасибо за участие в конкурсе, пожелать дальнейших успехов в использовании БЭМ и пригласить вступить в дружное БЭМ-сообщество!
...
Проект автора [Guria](https://github.com/Guria/ ), который достался на ревью Владимиру, представляет собой компонент, который реализует сложное двухуровневое меню с помощью нескольких составных `БЭМ`-блоков. По словам ревьюера, проект выполнен на достаточно высоком уровне, чувствуется глубокое погружение автора в тему. 
...
* Компонент выезжающего двухуровневого меню в виде БЭМ-библиотеки, автор [Guria](https://github.com/Guria )
