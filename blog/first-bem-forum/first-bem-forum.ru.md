...
Ммы настолько увлеклись интерфейсными фичами, что совсем забыли по одну очевидную необходимость — уникальный заголовок страницы для постов, которые открыты на отдельной странице. Мы решили сделать и его, хотя изначально даже не рассчитывали, что нам удастся выполнить такой объем задач.
...
![](https://img-fotki.yandex.ru/get/15489/44214498.bd/0_9bc25_81384ed_XL.pjg)
