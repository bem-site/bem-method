...
Выпустили новую версию [BH@4.1.0](https://github.com/bem/bh/releases/tag/v4.1.0). Теперь есть удобная возможность для генерации 
абсолютно любого HTML для каждого узла. Также появилась поддержка бинарных атрибутов (boolean attributes). Подробности читайте 
в [истории изменений (https://github.com/bem/bh/releases/tag/v4.1.0).
