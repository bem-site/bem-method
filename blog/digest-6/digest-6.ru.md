...
* [Организация файловой структуры](https://ru.bem.info/method/filesystem/) — переработали существующий документ, убрали лишнее и добавили недостающее, а также рассказали о принципах и причинах организации файловой структуры по БЭМ.
