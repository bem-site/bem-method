...
### Другие изменения
* Ускорили BH в версии [v3.2.3](https://github.com/bem/bh/releases/tag/v3.2.3) за счет улучшения эскейпинга. По синтетическим тестам прирост составил до 10%.
...
* Обновилили сайт bem.info !!до новой версии bem-components v2.0.0!!. Благодаря обновлению в дизайне обновили шапку примеров для блоков, теперь они читаются удобнее. Поправили отображение кода в статьях, документации и описаниях !!блоков!!. 
...
## Новости документации
  ...
  * Появились рабочие примеры для блоков [modal](https://ru.bem.info/libs/bem-components/v2/desktop/modal/) и [popup](https://ru.bem.info/libs/bem-components/v2/desktop/popup/). Найти их можно на отдельной вкладке [примеров](https://ru.bem.info/libs/bem-components/v2/desktop/popup/) на bem.info.
